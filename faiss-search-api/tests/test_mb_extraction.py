...
class TestExtractArtistMBIDs:
    ...
    def test_extract_from_json_string(self):
        ...
        play_data = {
            'artist_ids': '["5b11f4ce-a62d-471e-81fc-a69a8278c7da", "83d91898-7763-47d7-b03b-b92132375c47"]'
        }
    ...
    def test_extract_invalid_json(self):
        ...
        play_data = {
            'artist_ids': 'not valid json at all'
        }
        result = MBIDExtractor.extract_artist_mb_ids(play_data)
        assert result == []
    ...
    def test_extract_artist_mb_ids_filters_non_string_types(self):
        ...
        play_data = {
            'artist_ids': [123, None, True, {'invalid': 'object'}, '5b11f4ce-a62d-471e-81fc-a69a8278c7da']
        }
        result = MBIDExtractor.extract_artist_mb_ids(play_data)
        assert result == ['5b11f4ce-a62d-471e-81fc-a69a8278c7da']
...
class TestExtractLabelMBIDs:
    ...
    def test_extract_from_json_string(self):
        ...
        play_data = {
            'label_ids': '["5b11f4ce-a62d-471e-81fc-a69a8278c7da", "83d91898-7763-47d7-b03b-b92132375c47"]'
        }
    ...
    def test_extract_label_invalid_json(self):
        """Invalid JSON should return empty list."""
        play_data = {
            'label_ids': 'not valid json at all'
        }
        result = MBIDExtractor.extract_label_mb_ids(play_data)
        assert result == []
